package com.congcuong.savemyplace.data;
...
public class PlaceRepo {
    ...
    private PlaceSQLiteOpenHelper placeSQLiteOpenHelper;
    private static PlaceRepo INSTANCE;

    private PlaceRepo(Context context) {
        placeSQLiteOpenHelper = new PlaceSQLiteOpenHelper(context);
    }
    ...
    public List<Category> getCategories() {
        ...
        SQLiteDatabase database = placeSQLiteOpenHelper.getReadableDatabase();
    ...
    public List<Place> getPlaces(String cateID) {
        ...
        if (cursor != null && cursor.getCount() > 0){
            while (cursor.moveToNext()){
                ...
                String placeName = cursor.getString(cursor.getColumnIndexOrThrow(DBUtils.COLUMN_CATEGORY_NAME));
    ...
    public void insert(Place place){
        SQLiteDatabase database = placeSQLiteOpenHelper.getWritableDatabase();
